...
var pathImg,boyImg,cashImg,diamondsImg,jewelryImg,swordImg,oboyImg;
...
function preload(){
  ...
  oboyImg = loadImage ("Runner-1 copy.png");
...
Gameovers=createSprite(200,300);
    ...
    if (cashG.isTouching(boy)) {
      ...
      if(swordGroup.isTouching(boy)) {
        gameState=END;
         ...
         boy.addImage(oboyImg);
         
         
         
        
        Gameovers.visible=true
       Gameovers.depth = boy.depth+1
